...
public class ADYFX_Radialblur_Window : EditorWindow
{
   ...
   [MenuItem("ADYFX/贴图滤镜/※放射模糊", false, 3512)]
    ...
    {
        guibgtex = ADYFX_Editor.GetTex_AssetColor("080bd08d861517240aeb37bb37fa5dd8");
        shurukuangTex = ADYFX_Editor.GetTex_AssetColor("22118547ee1e4824999299c487e9e0b2");
        btnbgtex0 = ADYFX_Editor.GetTex_AssetColor("c8dc877f786fa5a4eb1aa6a1e9b5eb75");
        btnbgtex1 = ADYFX_Editor.GetTex_AssetColor("0b40623c182c80e4f948d3ee230782bc");
        btnbgtex2 = ADYFX_Editor.GetTex_AssetColor("c8dc877f786fa5a4eb1aa6a1e9b5eb75");
        zhunxintex = ADYFX_Editor.GetTex_AssetColor("060dce71f22650b40a1a68086f872902");
        TexselectionTishi = ADYFX_Editor.GetTex_AssetColor("26826c7db3f66d440981d5f4a74283f2");
        NoneyulanTex = ADYFX_Editor.GetTex_AssetColor("a5c693749460dda42a91d007ed037e56");
        ...
        btnsavetex01 = ADYFX_Editor.GetTex_AssetColor("166fe99a895791d4d8bab8be8c3d9b56");
        ...
        btnsavetex = ADYFX_Editor.GetTex_AssetColor("3391888902a7e6a44adfd1ce098b369b");
        //初始化各种坐标范围
        pointXrange = 393 - 23;
        pointYrange = 552 - 182;
        ...
        if (GUI.Button(new Rect(410, 320, 140, 33), "设为原图尺寸", BtnStyle)) //写入尺寸
        {
            if (yuanTex != null) 
            {
             //   resolution = new Vector2(yuanTex.width, yuanTex.height);
                resolution= ADYFX_Editor.GetTexWH(ADYFX_Editor.GetPath(yuanTex));
            }
        }
    ...
    void GSBlurSave()
    {
        if (yuanTex != null)
        {
            Texture2D YYY = ADYFX_Editor.GetYuanTu(ADYFX_Editor.GetPath(yuanTex));
