...
public class ADYFX_SplitTex : EditorWindow
{
    ...
    [MenuItem("ADYFX/贴图工具/※拆分通道存为贴图", false, 3030)]
    ...
    private void Sele02()
    {
        ...
        if (ADYFX_Editor.IsShuBiaoPos(new Vector4(881, 980, 194, 223), myMousePosition))//设置尺寸按钮 事件
        {
            ...
            {
                resolution1 = ADYFX_Editor.GetTexWH(ADYFX_Editor.GetPath( sourceTex4));
            }
    ...
    void StartWindow() //初始化窗口 获取所需资源
    {
        ...
        BGtexture02 = ADYFX_Editor.GetTex_AssetColor("c0ec52058fc935c4ea3b15c9561f9c1c");
    ...
    void Save()
    {
        ...
        hh = ADYFX_Editor.GetYuanTu(ADYFX_Editor.GetPath(sourceTex4));
        hh.Apply();
    ...
    {
        ADYFX_Editor.SetTexNpotScale(lowtexpath,sourceTex4,isImporter,lowTextureImporterNPOTScale,lowTextureImporterIsalpha);
        Debug.Log(AssetDatabase.GetAssetPath(sourceTex4));
        ...
        //        Debug.Log(tex);
        //        Debug.Log(ADYFX_Editor.GetPath(sourceTex4));
